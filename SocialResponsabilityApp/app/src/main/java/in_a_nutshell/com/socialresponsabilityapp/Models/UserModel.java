...
public class UserModel{
    ...
    public UserModel(UUID id, String fullName, double latitude, double longitude, double radius, int age, int gender, String profilePicture, List<IssueModel> issues) {
        this.id = id;
